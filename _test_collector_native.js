...
(async () => {
  ...
  // 同样的校验，这里再钉一道，防止有人把那条校验改掉）。
  {
    ...
    check('打包白名单确实含 rulecheck.js / magnet-core.js / site-templates.js 与 magnet-native.js',
      whitelist.has('rulecheck.js') && whitelist.has('magnet-core.js') &&
      whitelist.has('site-templates.js') && whitelist.has('magnet-native.js'));
  }
